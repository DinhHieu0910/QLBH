...
namespace QuanLyBanHang.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = QuanLyBanHangConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(QuanLyBanHangDbContext context)
        {
            _context = context;
        }
