...
{
    public abstract class QuanLyBanHangWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QuanLyBanHangWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QuanLyBanHangWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QuanLyBanHangDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QuanLyBanHangDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QuanLyBanHangDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QuanLyBanHangDbContext, Task<T>> func)
        {
            T result;
